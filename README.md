...
Deep Learning Model: Built a predictive model using Keras and TensorFlow within the finance domain.
Performance Metrics: Evaluated model effectiveness by calculating Sensitivity and the Area Under the ROC Curve (AUC-ROC).
Data Visualization: Created plots to visualize data distribution and the impact of balancing techniques.
